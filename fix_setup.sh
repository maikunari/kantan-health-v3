#!/bin/bash
# Quick fix for setup script to work with deploy user

cat > setup_api_fixed.sh << 'EOF'
#!/bin/bash
...
echo "Fixed setup script created. Upload it with:"
echo "scp setup_api_fixed.sh deploy@206.189.156.138:~/api-deploy/setup_api.sh"